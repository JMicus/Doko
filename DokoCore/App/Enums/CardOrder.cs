...
namespace Doppelkopf.Core.App.Enums
{
    public static class CardOrder
    {
        ...
        private static Dictionary<EGameType, string> _orders = new Dictionary<EGameType, string>()
        {
            { EGameType.Regular, Regular },
            { EGameType.SoloQueen, SoloD },
            { EGameType.SoloJack, SoloB },
            { EGameType.SoloClubs, SoloK },
            { EGameType.SoloSpades, SoloP },
            { EGameType.SoloHearts, SoloH },
            { EGameType.SoloDiamonds, SoloC },
            { EGameType.SoloNoTrumps, SoloF }
        };
        ...
        public static string OrderByGameType(EGameType gameType)
        {
            return _orders[gameType];
        }
    }
}
